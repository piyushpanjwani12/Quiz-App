...
public class SetPaperFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mytqaproj/GUI/paper.png"))); // NOI18N
        ...
        btnSet.setBackground(new java.awt.Color(0, 153, 204));
        ...
        lblLogout.setFont(new java.awt.Font("Tempus Sans ITC", 1, 14)); // NOI18N
    ...
    private void btnSetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSetActionPerformed
        ...
        int ans=JOptionPane.showConfirmDialog(null,"You have choosen"+subject+"and"+totalQuestion+"!. Do you want to continue?","Confirmation",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE);
        if(ans==JOptionPane.YES_OPTION)
        {
            try
            {
                String examId=ExamDao.getExamId();
                ExamPojo newExam=new ExamPojo(examId,subject,totalQuestion);
            ...
            {
                JOptionPane.showMessageDialog(null,"Sql exception:"+ex,"Failure",JOptionPane.ERROR_MESSAGE);
            }
        }
